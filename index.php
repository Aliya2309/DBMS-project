...
<body style='min-height: 100vh;'>
    <!--<div class='container d-flex flex-column justify-content align-items-center' style='height: 100vh;'>
        <div class="card">
            ...
            <a href="chef\chefs.php"> Chefs </a><br>
            <a href="supplier.php"> Supplier </a><br>
            <a href="ingd\ingredients.php"> Ingredients </a><br>
            <a href="transaction\transaction.php"> Transactions </a><br>
